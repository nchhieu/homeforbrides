  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-xs-12">
        <h1 class="title-page"><?php echo $PostCat['cat_name'];?></h1>
      </div>
    ...
    <!--div class="row">
      <div class="col-md-12 catintro"><?php echo $PostCat['cat_intro'];?></div>
    </div-->
    <div class="row">
          ...
          <div class="col-md-6"><a href="<?=$url;?>" class="blogtitle" title="<?=$row['post_title'];?>">
            ...
            <div class="meta">
              <ul class="list-unstyled list-inline blog-info" style="margin:10px 0px">
                <li>
                  <div class="fb-like" data-href="<?=Yii::app()->params['domain2'].$url;?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
                </li>
                <li>
