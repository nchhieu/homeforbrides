  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-xs-12">
        <h1 class="title-page"><?php echo $DeailInfo['subcat_name'];?></h1>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 ">
        <div class="sidebar">
          <div class="list-group"> <a href="#" class="list-group-item active"> Info </a>
            <?php
       foreach($Info as $row){
		   echo CHtml::link($row['subcat_name'], array('info/index','alias'=>$row['subcat_alias'],'id'=>$row['subcat_id']),array( 'class'=>'list-group-item','title'=>$row['subcat_name']));
	   }
		?>
          </div>
        </div>
