...
class Post extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('post_thumb', 'file', 'allowEmpty'=>true,'safe'=>true, 'types'=>'jpg, gif, png','maxSize' => (1024 * 10024)),
			array('post_title,cat_id', 'required'),
			array('post_type, cat_id, subcat_id, admin_id,post_order, topic_id', 'numerical', 'integerOnly'=>true),
			...
			array('post_updated_date,post_added_time,post_intro,post_thumb', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('post_id, post_type, cat_id,post_added_time, subcat_id,topic_id, sub_cat_name, post_title, post_thumb, post_intro, post_alias, post_status, post_hot, post_updated_date, admin_id', 'safe', 'on'=>'search'),
		);
	}
