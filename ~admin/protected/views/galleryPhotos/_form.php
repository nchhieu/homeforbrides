      ...
      <div class="form-group">
        <div class="col-sm-12 col-lg-12 controls">
          <div id="container">
            ...
            <br />
            <a id="pickfiles" href="javascript:;" class="btn btn-xlarge btn-primary">[Select files]</a> <a id="uploadfiles" href="javascript:;" class="btn btn-xlarge btn-primary">[Upload files]</a> </div>
        </div>
      </div>
    </div>
  </div>
...
var uploader = new plupload.Uploader({
	...
	container: 'container',
	max_file_size : '20mb',
	url : 'index.php?r=GalleryPhotos/UploadFilesPlupload&gallery_id=<?php echo $gallery_id;?>&logo=<?php echo $logo;?>',
