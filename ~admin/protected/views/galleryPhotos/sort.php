    ...
    <div id="reorder-gallery">
      <ul id="sortable">
        <?php
				...
				foreach($data as $row){
    			?>
        <li id="ID_<?php echo $row['gallery_photo_id'];?>"><img src="<?php echo $row['gallery_thumb'];?>" title="<?php echo $row['gallery_photo_id'];?>" alt="<?php echo $row['gallery_photo_id'];?>" /></li>
        <?php
				} // for
     			?>
      </ul>
...
$(function() {
  $("#sortable").sortable({
				...
				update: function(){
						...
						jQuery.post("index.php?r=GalleryPhotos/UpdateSort", order, 
