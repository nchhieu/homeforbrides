...
<fieldset>
  <div class="row">
    ...
    <div class="col-md-6">
    <div class="form-group"> <?php echo $form->labelEx($model,'slider_photos',array('class'=>'col-sm-4 col-lg-3 control-label')); ?>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="col-md-6">
      <div class="form-group"> <?php echo $form->labelEx($model,'slider_status',array('class'=>'col-sm-4 col-lg-3 control-label')); ?>
        <div class="col-sm-8 col-lg-9 controls"> <?php echo $form->dropDownList($model,'slider_status',array('Show'=>'Show','Hide'=>'Hide'), array('class'=>'form-control')); ?> <?php echo $form->error($model,'slider_status'); ?> </div>
      </div>
    </div>
  </div>
