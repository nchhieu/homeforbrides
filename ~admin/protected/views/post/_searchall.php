...
<div class="col-sm-2 col-lg-2"> <?php echo $form->label($model,'post_title'); ?> <?php echo $form->textField($model,'post_title',array('size'=>9,'maxlength'=>9,'class'=>'form-control')); ?> </div>
<div class="col-sm-2 col-lg-2"> <?php echo $form->label($model,'post_type'); ?><?php echo $form->dropDownList($model,'post_type',array('Post','Photography','Videography'),array('empty'=>'Any','class'=>'form-control')); ?> </div>
...
<div class="col-sm-2 col-lg-2"> <?php echo $form->label($model,'subcat_id'); ?> <?php echo $form->dropDownList($model,'subcat_id',CHtml::listData($PostSubcat, 'subcat_id', 'subcat_name'),array('empty'=>'Choose sub category','class'=>'form-control')); ?> </div>
